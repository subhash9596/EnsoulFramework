...
public class SendEmail 
{
	...
	public static void execute(String reportFileName) throws Exception
	{
		...
		SendEmail.sendMail("ingale.subhash@gmail.com", "baba9596", "smtp.gmail.com",
				...
				to, cc, "Automation trigger mail for Ensoul",	
				"Please find attached "+reportFileName+" file for detailed status of "+project+" automation execution build status.",
				path, reportFileName);
	}
	...
	public static boolean sendMail(String userName,
		...
		try{
			...
			objMessageBodyPart.setContent(
					"<h2>Mail from "+project+" Automation Project!</h2></br>" + text, "text/html");
